...
<head>
    ...
    <title>Sistem Monitoring Evaluasi Program</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a class="mb-3 fw-bold" href="logout.php" style="position: absolute; bottom: 0;">LOGOUT</a>
        </div>
    </div>
    ...
    if (isset($_GET["page"])) {
        ...
        switch ($page) {
            ...
            case 'laporan':
                ...
                //program
            case 'program':
                include 'page/program/program.php';
                break;
                //user
            case 'user':
